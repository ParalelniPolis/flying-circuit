<template>
<div class="row">
  <h1> True hackathon </h1>
  <p>
    Hackatoshi’s Flying Circuit is an intervention of cypherpunks into both virtual and physical public space.
    It's an weekend long exertion aiming to concentrate inspiration, knowledge and skill to exploit comfortism and compliance
    with status quo.
<!--    <a> Read the full manifesto... </a>-->
  ...
  <div class="six columns">
    <h3> Inside || Online </h3>
    <p> This track is focused on cloud societies. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
  </div>
  <div class="six columns">
